...
const handleSubmit = ()=>{
  ...
  return (
    <div className='w-full bg-white bg-opacity-10 max-h-40 rounded-lg px-4 py-4 overflow-auto relative'>
        ...
        rows={1} className='border-0 bg-transparent outline-none w-11/12' value={value} type='text'
        onChange={(e)=>setValue(e.target.value)}/>
        <img
        onClick={handleSubmit}
        src='./send.png' width={20} alt='send-button' className='absolute top-4 right-3 hover:cursor-pointer
